...
class PlaybackFragment :
    ...
    override fun setCurrentSong(song: Song?) {
        song?.let { song ->
            ...
            artistTextView.text = song.friendlyArtistName ?: song.albumArtist ?: getString(com.simplecityapps.core.R.string.unknown)
            albumTextView.text = song.album ?: getString(com.simplecityapps.core.R.string.unknown)
